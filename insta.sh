# !/bin/bash
# author         : ./THE DARK ANONYMOUS
# team           : ./THE DARK ANONYMOUS VIKRANT
# Decode By vikrant
...
# thread limit => use simple name :v
limit=50
...
\e[1;31mcontact: https://www.facebook.com/DARK.ANONYMOUS.VIKRANT\e[1;37m
'''
